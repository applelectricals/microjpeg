...
export default function LegalTerms() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        title="Terms of Service - Micro JPEG"
        description="Read our Terms of Service to understand your rights and responsibilities when using Micro JPEG's image compression services. Learn about our service limits, payments, and data processing policies."
        canonicalUrl="https://microjpeg.com/legal/terms"
        keywords="terms of service, legal terms, image compression terms, micro jpeg policies"
      />
      <Header />
